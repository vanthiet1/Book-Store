...
const UserSidebar = () => {
    ...
    return (
        <>
            <div className={`w-[25%] border-r border-[#1E1E20] pr-5 max-lg:fixed max-lg:bg-[#000000] max-lg:h-dvh max-lg:top-[70px] max-lg:w-[400px] max-lg:z-20 max-lg:${displayUserSidebar} pl-5 max-lg:ease-in max-lg:duration-300 max-lg:pt-[50px] max-lg:left-0 `}>
